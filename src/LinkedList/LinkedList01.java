...
public class LinkedList01 {
    public static void main(String[] args) {
        LinkedList<String> ll1= new LinkedList<>(Arrays.asList("erdem","mehmet","samet","yahgmur"));
        ...
        System.out.println(ll1.element());//mehmet---elemnet() methodu listin sadece ilk nodedur
        //ll3.remove(33);
